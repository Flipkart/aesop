 ...
 */
public class AsyncKafkaDeleteProcessor extends DeleteDestinationStoreProcessor {
    /**
     * Logger for this class
     */
    private static final Logger LOGGER = LogFactory.getLogger(AsyncKafkaDeleteProcessor.class);
