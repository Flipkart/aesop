 ...
 */
public class AsycKafkaEventProcessor extends KafkaEventProcessor {

    @Override
    @SuppressWarnings(value = "unchecked")
    public ConsumerCallbackResult submitRecord(ProducerRecord producerRecord) throws Exception{

        kafkaClient.getClient().send(producerRecord);
        /*  NOTE :  Callback not provided with this implementation */
