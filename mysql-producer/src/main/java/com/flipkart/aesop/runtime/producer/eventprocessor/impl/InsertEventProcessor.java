...
/**
 * The <code>InsertEventProcessor</code> processes WriteRowsEvent from source. This event is received whenever insertion operation happens at the source.
 * @author Shoury B
...
public class InsertEventProcessor implements BinLogEventProcessor{
	...
	public void process(BinlogEventV4 event, OpenReplicationListener listener)throws Exception {
		...
		listener.getMysqlTransactionManager().setSource(wre.getTableId());
