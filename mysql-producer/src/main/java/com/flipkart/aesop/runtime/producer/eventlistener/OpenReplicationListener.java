 ...
 * <a href="https://code.google.com/p/open-replicator/">OpenReplicator</a> provides callback to this implementation as and when
...
public class OpenReplicationListener implements BinlogEventListener {
	 ...
	 */
	public OpenReplicationListener(MysqlTransactionManager mysqlTransactionManager, Map<Integer,BinLogEventProcessor> eventsMap,String binLogPrefix) {
	...
	public void onEvents(BinlogEventV4 event) {
		...
		try {
			/** Get the Event processor corresponding to the event and delegate the processing to appropriate event processor */
