 ...
 */
package com.flipkart.aesop.runtime;

/**
 * The <code>RuntimeFrameworkConstants</code> class is a placeholder for all runtime framework constants.
 * 
 * @author Regunath B
 * @version 1.0, 03 Jan 2014
 */
public class RuntimeFrameworkConstants {
