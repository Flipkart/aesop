...
public class Person extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static com.flipkart.aesop.events.ortest.Person.Builder newBuilder() {
    return new com.flipkart.aesop.events.ortest.Person.Builder();
  }
  
  /** Creates a new Person RecordBuilder by copying an existing Builder */
  public static com.flipkart.aesop.events.ortest.Person.Builder newBuilder(com.flipkart.aesop.events.ortest.Person.Builder other) {
    return new com.flipkart.aesop.events.ortest.Person.Builder(other);
  }
  
  /** Creates a new Person RecordBuilder by copying an existing Person instance */
  public static com.flipkart.aesop.events.ortest.Person.Builder newBuilder(com.flipkart.aesop.events.ortest.Person other) {
    return new com.flipkart.aesop.events.ortest.Person.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Person>
    ...
    private Builder() {
      super(com.flipkart.aesop.events.ortest.Person.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.flipkart.aesop.events.ortest.Person.Builder other) {
      super(other);
    ...
    private Builder(com.flipkart.aesop.events.ortest.Person other) {
            super(com.flipkart.aesop.events.ortest.Person.SCHEMA$);
      if (isValidValue(fields()[0], other.key)) {
        this.key = data().deepCopy(fields()[0].schema(), other.key);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'key' field */
    public com.flipkart.aesop.events.ortest.Person.Builder setKey(java.lang.Long value) {
    ...
    public com.flipkart.aesop.events.ortest.Person.Builder clearKey() {
      key = null;
    ...
    /** Sets the value of the 'firstName' field */
    public com.flipkart.aesop.events.ortest.Person.Builder setFirstName(java.lang.CharSequence value) {
    ...
    public com.flipkart.aesop.events.ortest.Person.Builder clearFirstName() {
      firstName = null;
    ...
    /** Sets the value of the 'lastName' field */
    public com.flipkart.aesop.events.ortest.Person.Builder setLastName(java.lang.CharSequence value) {
    ...
    public com.flipkart.aesop.events.ortest.Person.Builder clearLastName() {
      lastName = null;
    ...
    /** Sets the value of the 'birthDate' field */
    public com.flipkart.aesop.events.ortest.Person.Builder setBirthDate(java.lang.Long value) {
    ...
    public com.flipkart.aesop.events.ortest.Person.Builder clearBirthDate() {
      birthDate = null;
    ...
    /** Sets the value of the 'deleted' field */
    public com.flipkart.aesop.events.ortest.Person.Builder setDeleted(java.lang.CharSequence value) {
    ...
    public com.flipkart.aesop.events.ortest.Person.Builder clearDeleted() {
      deleted = null;
