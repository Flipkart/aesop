...
/**
 * Brings up a Databus Relay Client for change events of a specific type i.e. com.flipkart.aesop.events.example.person.Person. Note that this client connects to a Relay
 ...
 * 
 * <pre>
 * java -cp .:lib/*.jar com.flipkart.aesop.relay.RelayClientMain -p conf/client_person.properties
 * 
 * <pre>
 * 
 * @author Regunath B
